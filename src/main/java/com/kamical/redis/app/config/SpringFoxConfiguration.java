...
public class SpringFoxConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.kamical.redis.app.controller")).build()
                .apiInfo(metaData());
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("kcm", "https://github.com/kartikmandal", "kartik.cse43@gmail.com"))
                .build();
    }
